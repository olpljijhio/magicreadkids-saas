...
/**
 * Client Redis Upstash (optionnel en dev)
 */
...
/**
 * Rate limiter général (exemple) : 10 requêtes / minute
 */
...
/**
 * Rate limiter dédié à la génération d’histoires : 3 / heure
 */
...
/**
 * Fallback en mémoire pour le dev (NON sécurisé, ne pas utiliser en prod)
 */
